...
import ChatSidebar from "./ChatSidebar"; // apna path adjust karo
import { useDispatch, useSelector } from "react-redux";
import {
  getChatList,
  getChatHistory,
...
import { selectPreChatPayload } from "../../../features/chat/preChatSlice/preChatSlice";
...
const ChatToText = () => {
  ...
  // Pre-chat answers selector — pehle message ke baad null return karega
  const preChatPayload = useSelector(selectPreChatPayload);
  ...
  const handleSend = () => {
    ...
    // Send message — pehli baar preChatPayload attach hoga, baad mein null
    dispatch(
      sendMessage({
        chatId,
        message: input,
        ...
        tempId,
        botTempId,
        preChatData: preChatPayload, // null hoga agar already bheja ja chuka hai
      }),
    );
