  ...
  return (
    <div className="main-content">
      <div className="settings-container">
        ...
        {/* Account Section */}
        <div className="section-header">{t("account")}</div>
        ...
        {/* Data & Privacy Section */}
        <div className="section-header">{t("dataPrivacy")}</div>
        ...
        <div className="settings-section">
          ...
          >
            <div className="setting-item-left">
              ...
              <div className="setting-info">
                <h4 className="red">{t("deleteAccount")}</h4>
              </div>
            </div>
        ...
        {/* About Section */}
        <div className="section-header">{t("about")}</div>
